...
{
    public class MusicChangerView : View
    {
        ...
        {
            if (_volume.MusicVolume > 0)
            {
                _slider.value = _volume.MusicVolume;
                _toggle.isOn = true;
        ...
        private void ReduceSliderValue()
        {
            ...
            _volume.MusicVolume = _slider.value;
        }
